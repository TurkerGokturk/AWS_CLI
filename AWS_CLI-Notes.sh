...
aws ec2 describe-instances --query "Reservations[].Instances[].PublicIpAddress[]" # Query of Public_ID
...
# If you will enter more IDs do not putt a comma "," just make SPACE
